...
-- 입력/수정하는 데이터에 문제가 없는지 자동으로 검사해준다.
...
VALUES
    ...
    (2, "user02", "pass02", "육관순", "여", "010-1111-1111", "ym@gmail.com");
...
VALUES
	...
	(2, "user02", "pass02", "유관순", "여자", "010-4567-1234", NULL);
...
VALUES
	(1, "user01", "pass01", "홍길동", "남", "010-1234-5678", null),
    (2, "user02", "pass02", "유관순", "여", "010-5678-1234", null);
    
SELECT * FROM user_primarykey;

-- FOREIGN KEY
-- 참조된 다른 테이블에서 제공하는 값만 사용할 수 있음.
-- FOREIGN KEY 제약조건에 의해 테이블 간의 관계가 형성돰
-- 제공되는 값 외에는 NULL을 사용할 수 있음.
-- 설정되어 있는 경우에는 컬럼을 변경하지 못함.

DROP TABLE IF EXISTS user_grade;
CREATE TABLE IF NOT EXISTS user_grade (
	grade_code INT NULL NULL UNIQUE,
...
INSERT INTO user_foreignkey1
	(user_no, user_id, user_pwd, user_name, gender, phone, email, grade_code)
VALUES
    (3, "user02", "pass02", "유관순", "여", "010-1234-1234", null, null);
...
VALUES
	(1, "user01", "pass01", "홍길동", "남", "010-1234-1234", null, 10),
    (2, "user02", "pass02", "유관순", "여", "010-4567-4567", null, 20);
